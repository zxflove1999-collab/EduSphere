...
CREATE TABLE t_dorm_survey (
    ...
    sleep_time_pref TINYINT DEFAULT 0 COMMENT '睡眠时间偏好',
    wake_time_pref TINYINT DEFAULT 0 COMMENT '起床时间偏好',
    nap_habit TINYINT DEFAULT 0 COMMENT '午睡习惯',
    smoking_status TINYINT DEFAULT 0 COMMENT '是否抽烟',
    roommate_smoke_accept TINYINT DEFAULT 0 COMMENT '能否接受室友抽烟',
    gaming_freq TINYINT DEFAULT 0 COMMENT '游戏频率',
    headphone_usage TINYINT DEFAULT 0 COMMENT '耳机使用习惯',
    chatting_pref TINYINT DEFAULT 0 COMMENT '聊天社交偏好',
    guest_acceptance TINYINT DEFAULT 0 COMMENT '室友带客人接受度',
    group_activity_willingness TINYINT DEFAULT 0 COMMENT '宿舍集体活动意愿',
    hygiene_requirement TINYINT DEFAULT 0 COMMENT '卫生要求',
    organization_level TINYINT DEFAULT 0 COMMENT '整理物品程度',
    roommate_hygiene_tolerance TINYINT DEFAULT 0 COMMENT '室友卫生容忍度',
    quiet_study_need TINYINT DEFAULT 0 COMMENT '安静学习需求',
    noise_tolerance_level TINYINT DEFAULT 0 COMMENT '噪音容忍等级',
    dorm_food_freq TINYINT DEFAULT 0 COMMENT '宿舍吃东西频率',
    fragrance_usage TINYINT DEFAULT 0 COMMENT '香氛使用频率',
    smell_sensitivity TINYINT DEFAULT 0 COMMENT '气味敏感度',
